...
2. For each skill, identify exactly 5 examples of what a user might actually say in a real session that would make this skill relevant.
...
6. After reading `PROMPTS.md` you MUST add more casual nature to the prompts you see.
7. Output the prompts as a simple bullet list. No extra commentary.
